...
namespace App\DataTables\Yajra\Services;

use Illuminate\Contracts\View\Factory;
use Illuminate\Support\Facades\Config;
use Maatwebsite\Excel\Classes\LaravelExcelWorksheet;
use Maatwebsite\Excel\Writers\LaravelExcelWriter;
use App\DataTables\Yajra\Contracts\DataTableButtonsContract;
use App\DataTables\Yajra\Contracts\DataTableContract;
use App\DataTables\Yajra\Contracts\DataTableScopeContract;
use Yajra\Datatables\Datatables;
use App\DataTables\Yajra\Transformers\DataTransformer;
use App\Exports\ExportFromDatatable;
/**
 * Class DataTable.
 *
...
abstract class DataTable implements DataTableContract, DataTableButtonsContract
{
    ...
    {
        return \Excel::download($this->buildExcelFile(), 'export_data.xlsx');
    }
    ...
    protected function buildExcelFile()
    {
        ...
        $export = new ExportFromDatatable($this->getDataForExport());
        $headers = [];
        if(count($this->getDataForExport()) > 0)
            $headers = array_keys($this->getDataForExport()[0]);
