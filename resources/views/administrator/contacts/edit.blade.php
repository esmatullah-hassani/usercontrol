            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::model($contact, ['route' => ['contacts.update', $contact], 'method' => 'put', 'class' => 'form-horizontal']) !!}
                            <div class="form-group {{ $errors->has('user') ? ' has-error' : '' }}">
                                {!! Form::label('user', trans('general.name'), ['class' => 'control-label col-sm-4']) !!}                                
                                <div class="col-sm-5">
                                    {!! Form::hidden('user', $contact->user_id, ['class' => 'form-control dropdown-all-users', 'placeholder' => trans('general.select')]) !!}
                                    @if ($errors->has('user'))
