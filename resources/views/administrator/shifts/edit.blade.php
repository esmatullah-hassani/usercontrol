            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading clearfix">
                        {{ trans('general.edit_shift') }} 
                        <a class="pull-right btn btn-default btn-xs" href="{{route('shifts.index')}}" >
                            <i class="fa fa-arrow-left"></i> {{ trans('general.back') }}
                        </a>                                           
                    </div>
                    <div class="panel-body">
                        @include('layouts.message')
                        {!! Form::model($shift, ['route' => ['shifts.update', $shift], 'method' => 'put', 'class' => 'form-horizontal']) !!}
                            ...
                            <div class="form-group {{ $errors->has('from-to') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-5">
                                    {!! Form::text('from-to', null, ['class' => 'form-control ltr']) !!}     
                            ...
                            <div class="form-group"> 
                                <div class="col-sm-offset-4 col-sm-4">
                                    <div class="checkbox">
                                        <label>{!! Form::checkbox('default', 1, $shift->default) !!} {{ trans('general.default') }}</label>
                                    </div>
                                </div>
                            </div>                          
                            <hr>                        
