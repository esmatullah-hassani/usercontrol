...
$(function(){
    ...
    $(".dropdown-departments").select2({        
        ajax: {
            ...
            data: function (params) {
                ...
                if ($('#teams option:selected').length > 0 && $('#teams option:selected').val() == "") {
                    return {};
                }

                team = $('#teams option:selected').val();
   ...
   $(".dropdown-statuses").select2({        
        ajax: {
            url: BaseUrl + "/api/select2/statuses",
            dataType: 'json',
            data: function (params) {                            
                if ($('#teams option:selected').length > 0 && $('#teams option:selected').val() == "") {
                    return {};
        ...
        initSelection: function(element, callback) {            
            var id = $(element).val();
            if (id !== "") {
                $.ajax(BaseUrl + "/api/select2/status/" + id, {
                    dataType: "json"
                }).done(function(data) { callback(data); });
            }
        },
